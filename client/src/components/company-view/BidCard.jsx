        ...
        <div className="row pb-3">
          <div className="mb-2">
            <span className="card-text">
              <span className="card-text">
                <span className="fw-bold">Frequency:</span> {posting.frequency}
              </span>
            </span>
          </div>
          <div className="mb-2">
            <span className="card-text">
              <span className="fw-bold">Client:</span> {posting.customer.name}
            </span>
          </div>
          <div className="mb-2">
            <span className="fw-bold">Location:</span>{" "}
            {createLocationString(posting.customer.location)}
          </div>
          <div className="mb-2">
