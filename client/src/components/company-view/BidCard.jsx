      ...
      <div className="card-body">
        <div className="row mt-2 mb-4">
          <div className="col-6">
            ...
            {accepted ? <span className="text-secondary fst-italic">Accepted</span> : <span className="text-secondary fst-italic">Pending</span> }
          </div>
          <div className="col-6 d-flex justify-content-end align-items-center">
            ...
            <button onClick={deleteBid} className={"border-0 ms-4 rounded-pill delete-button"}>
        ...
        <div className="row pb-3">
          <div className="mb-2">
            <span className="card-text">
              <span className="card-text"><span className="fw-bold">Frequency:</span> {posting.frequency}</span>
            </span>
          </div>
          <div className="mb-2">
            <span className="card-text"><span className="fw-bold">Client:</span> {posting.customer.name}</span>
          </div>
          <div className="mb-2">
            <span className="fw-bold">Location:</span> {createLocationString(posting.customer.location)}
