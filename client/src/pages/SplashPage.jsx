      ...
      <div className="min-vh-100 d-flex justify-content-center align-items-center landing-page-bg">
        <div className=" row align-items-center">
          <div className="col pe-3 text-white">
            ...
            <p className="body-font">Input a bid on the work you need done, and the professionals will come to you. </p>
          </div>
          <div className="py-5 p-4 border border-1 rounded bg-light col d-flex flex-column">
            ...
            <button onClick={toggleForms} className="btn border rounded-pill green-border green-color text-dark fs-6 header">{showLoginForm ? "Sign Up" : "Login" }</button>
            </div>
          </div>
        </div>
      </div>
